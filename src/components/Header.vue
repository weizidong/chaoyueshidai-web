...
<template>
  <div class="header">
    <!--<div><img src="/static/img/logo02.png" alt="LOGO"></div>-->
    <el-dropdown class="user" @command="handleCommand">
      <span class="el-dropdown-link">
        <img :src="mine.headimgurl || '/static/img/user.png'">
        <span>{{mine.nickname || '管理员'}}</span>
    ...
    <el-dialog v-if="dialog.data.id" :modal-append-to-body="false" :show-close="false" :visible.sync="dialog.show">
      <div slot="title" class="title">
        <img :src="dialog.data.headimgurl || '/static/img/admin.png'">
      ...
      return {
        ...
        rule2: {
          old: [
            ...
            {type: 'string', min: 8, message: '密码长度不少于8位！', trigger: 'blur'},
          ],
          pwd: [{
            type: 'string',
            required: true,
